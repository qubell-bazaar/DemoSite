...
CREATE TABLE `BLC_ADDRESS` (
  ...
  `IS_BUSINESS` BOOL DEFAULT NULL,
  `IS_DEFAULT` BOOL DEFAULT NULL,
  `LAST_NAME` varchar(255) DEFAULT NULL,
  `POSTAL_CODE` varchar(255) NOT NULL,
  `PRIMARY_PHONE` varchar(255) DEFAULT NULL,
  `SECONDARY_PHONE` varchar(255) DEFAULT NULL,
  `STANDARDIZED` BOOL DEFAULT NULL,
...
CREATE TABLE `BLC_ADMIN_SECTION` (
  ...
  `USE_DEFAULT_HANDLER` BOOL DEFAULT NULL,
  `ADMIN_MODULE_ID` bigint(20) NOT NULL,
...
CREATE TABLE `BLC_ADMIN_USER` (
  `ADMIN_USER_ID` bigint(20) NOT NULL,
  `ACTIVE_STATUS_FLAG` BOOL DEFAULT NULL,
...
CREATE TABLE `BLC_CURRENCY` (
  ...
  `DEFAULT_FLAG` BOOL DEFAULT NULL,
...
CREATE TABLE `BLC_CUSTOMER` (
  ...
  `DEACTIVATED` BOOL DEFAULT NULL,
  `EMAIL_ADDRESS` varchar(255) DEFAULT NULL,
  `FIRST_NAME` varchar(255) DEFAULT NULL,
  `LAST_NAME` varchar(255) DEFAULT NULL,
  `PASSWORD` varchar(255) DEFAULT NULL,
  `PASSWORD_CHANGE_REQUIRED` BOOL DEFAULT NULL,
  `IS_PREVIEW` BOOL DEFAULT NULL,
  `RECEIVE_EMAIL` BOOL DEFAULT NULL,
  `IS_REGISTERED` BOOL DEFAULT NULL,
...
CREATE TABLE `BLC_FIELD` (
  ...
  `SEARCHABLE` BOOL DEFAULT NULL,
  `TRANSLATABLE` BOOL DEFAULT NULL,
...
CREATE TABLE `BLC_FLD_GROUP` (
  ...
  `INIT_COLLAPSED_FLAG` BOOL DEFAULT NULL,
  `NAME` varchar(255) DEFAULT NULL,
...
CREATE TABLE `BLC_FULFILLMENT_GROUP` (
  ...
  `SHIPPING_PRICE_TAXABLE` BOOL DEFAULT NULL,
  ...
  `SHIPPING_OVERRIDE` BOOL DEFAULT NULL,
...
CREATE TABLE `BLC_FULFILLMENT_GROUP_FEE` (
  `FULFILLMENT_GROUP_FEE_ID` bigint(20) NOT NULL,
  `AMOUNT` decimal(19,5) DEFAULT NULL,
  `FEE_TAXABLE_FLAG` BOOL DEFAULT NULL,
  `NAME` varchar(255) DEFAULT NULL,
  `REPORTING_CODE` varchar(255) DEFAULT NULL,
  `TOTAL_FEE_TAX` decimal(19,5) DEFAULT NULL,
  `FULFILLMENT_GROUP_ID` bigint(20) NOT NULL,
...
CREATE TABLE `BLC_FULFILLMENT_OPTION` (
  ...
  `USE_FLAT_RATES` BOOL DEFAULT NULL,
...
CREATE TABLE `BLC_LOCALE` (
  ...
  `DEFAULT_FLAG` BOOL DEFAULT NULL,
  `FRIENDLY_NAME` varchar(255) DEFAULT NULL,
  `USE_IN_SEARCH_INDEX` BOOL DEFAULT NULL,
  `CURRENCY_CODE` varchar(255) DEFAULT NULL,
...
CREATE TABLE `BLC_OFFER` (
  ...
  `APPLY_OFFER_TO_MARKED_ITEMS` BOOL DEFAULT NULL,
  `APPLY_TO_SALE_PRICE` BOOL DEFAULT NULL,
  `ARCHIVED` char(1) DEFAULT NULL,
  `AUTOMATICALLY_ADDED` BOOL DEFAULT NULL,
  `COMBINABLE_WITH_OTHER_OFFERS` BOOL DEFAULT NULL,
  ...
  `REQUIRES_RELATED_TAR_QUAL` BOOL DEFAULT NULL,
  `STACKABLE` BOOL DEFAULT NULL,
  `START_DATE` datetime DEFAULT NULL,
  `TARGET_SYSTEM` varchar(255) DEFAULT NULL,
  `TOTALITARIAN_OFFER` BOOL DEFAULT NULL,
  `USE_NEW_FORMAT` BOOL DEFAULT NULL,
...
CREATE TABLE `BLC_ORDER` (
  ...
  `TAX_OVERRIDE` BOOL DEFAULT NULL,
...
CREATE TABLE `BLC_ORDER_ITEM` (
  `ORDER_ITEM_ID` bigint(20) NOT NULL,
  `DISCOUNTS_ALLOWED` BOOL DEFAULT NULL,
  `ITEM_TAXABLE_FLAG` BOOL DEFAULT NULL,
  `NAME` varchar(255) DEFAULT NULL,
  `ORDER_ITEM_TYPE` varchar(255) DEFAULT NULL,
  `PRICE` decimal(19,5) DEFAULT NULL,
  `QUANTITY` int(11) NOT NULL,
  `RETAIL_PRICE` decimal(19,5) DEFAULT NULL,
  `RETAIL_PRICE_OVERRIDE` BOOL DEFAULT NULL,
  `SALE_PRICE` decimal(19,5) DEFAULT NULL,
  `SALE_PRICE_OVERRIDE` BOOL DEFAULT NULL,
...
CREATE TABLE `BLC_ORDER_ITEM_ADJUSTMENT` (
  ...
  `APPLIED_TO_SALE_PRICE` BOOL DEFAULT NULL,
  `ADJUSTMENT_REASON` varchar(255) NOT NULL,
  `ADJUSTMENT_VALUE` decimal(19,5) NOT NULL,
  `OFFER_ID` bigint(20) NOT NULL,
  `ORDER_ITEM_ID` bigint(20) DEFAULT NULL,
...
CREATE TABLE `BLC_ORDER_ITEM_PRICE_DTL` (
  ...
  `QUANTITY` int(11) NOT NULL,
  `USE_SALE_PRICE` BOOL DEFAULT NULL,
  `ORDER_ITEM_ID` bigint(20) DEFAULT NULL,
...
CREATE TABLE `BLC_PAGE` (
  ...
  `UPDATED_BY` bigint(20) DEFAULT NULL,
  `DESCRIPTION` varchar(255) DEFAULT NULL,
  `EXCLUDE_FROM_SITE_MAP` BOOL DEFAULT NULL,
  `FULL_URL` varchar(255) DEFAULT NULL,
  `OFFLINE_FLAG` BOOL DEFAULT NULL,
...
CREATE TABLE `BLC_PAYMENT_LOG` (
  ...
  `TRANSACTION_SUCCESS` BOOL DEFAULT NULL,
...
CREATE TABLE `BLC_PRODUCT` (
  `PRODUCT_ID` bigint(20) NOT NULL,
  `ARCHIVED` char(1) DEFAULT NULL,
  `CAN_SELL_WITHOUT_OPTIONS` BOOL DEFAULT NULL,
  `DISPLAY_TEMPLATE` varchar(255) DEFAULT NULL,
...
CREATE TABLE `BLC_PRODUCT_BUNDLE` (
  `AUTO_BUNDLE` BOOL DEFAULT NULL,
  `BUNDLE_PROMOTABLE` BOOL DEFAULT NULL,
  `ITEMS_PROMOTABLE` BOOL DEFAULT NULL,
...
CREATE TABLE `BLC_PRODUCT_OPTION` (
  ...
  `REQUIRED` BOOL DEFAULT NULL,
  `OPTION_TYPE` varchar(255) DEFAULT NULL,
  `USE_IN_SKU_GENERATION` BOOL DEFAULT NULL,
...
CREATE TABLE `BLC_SEARCH_FACET` (
  ...
  `MULTISELECT` BOOL DEFAULT NULL,
  `LABEL` varchar(255) DEFAULT NULL,
  `REQUIRES_ALL_DEPENDENT` BOOL DEFAULT NULL,
  `SEARCH_DISPLAY_PRIORITY` int(11) DEFAULT NULL,
  `SHOW_ON_SEARCH` BOOL DEFAULT NULL,
  `FIELD_ID` bigint(20) NOT NULL,
...
CREATE TABLE `BLC_SKU` (
  ...
  `FULFILLMENT_TYPE` varchar(255) DEFAULT NULL,
  `INVENTORY_TYPE` varchar(255) DEFAULT NULL,
  `IS_MACHINE_SORTABLE` BOOL DEFAULT NULL,
  `LONG_DESCRIPTION` longtext,
  `NAME` varchar(255) DEFAULT NULL,
  `RETAIL_PRICE` decimal(19,5) DEFAULT NULL,
  `SALE_PRICE` decimal(19,5) DEFAULT NULL,
